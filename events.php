...
<body>
    <div class="sidebar" id="sidebar">
      <div class="logo">
        ...
        <a href="homePage.html"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        <a href="volunteers.html"><i class="fas fa-users"></i> Volunteers</a>
        <a href="#"><i class="fas fa-calendar-alt"></i> Events</a>
        <a href="map.html"><i class="fas fa-map-marker-alt"></i> Map</a>
        <a href="sms.html"><i class="fas fa-envelope"></i> SMS Alerts</a>
    </div>
